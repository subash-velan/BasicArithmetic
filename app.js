...
console.log('Adition of two numbers : ' + Addition.addTwoNumbers(2,2));

var Multiply = require('./models/Multiply.js');
console.log('Multiplication of two numbers : ' + Multiply.multiplyTwoNumbers(2,2));
